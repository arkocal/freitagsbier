...
var beer_config = CreateGlassConfig(
	_width  = GetRandom(30, 100),
	_height = GetRandom(70, 100),
...
function PourBeer(canvas, config)
{
        if (config == null) {
	    config = beer_config;
	}
        var beer_ctx = canvas.getContext('2d');
